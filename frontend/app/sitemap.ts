...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { route: "/blog/koc-vs-influencer", priority: 0.7 },
    { route: "/blog/pledge-economy-moat", priority: 0.7 },
    { route: "/blog/koc-level-up-system", priority: 0.7 },
    { route: "/blog/tiktok-shop-koc-ecosystem", priority: 0.7 },
