...
export default function MyProducts() {
  ...
  const tierBadge = (tier: string) => {
    ...
    const labels: Record<string, string> = { L3: "Partner", L2: "Creator", L1: "Explorer" };
    return (
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <NavBar user={null} role="merchant" title="My Products" />
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-4 max-h-[80vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="p-5 border-b border-slate-100 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">Recommending KOCs for &quot;{matchModal.productName}&quot;</p>
                </div>
              ...
              <div className="flex-1 overflow-y-auto p-5">
                {matchingLoading ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-slate-400">Analyzing best matches...</p>
                  </div>
                ) : matches.length === 0 ? (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {tierBadge(m.tier)}
                            <span className="text-xs font-mono text-pink-600 font-bold">{m.match_score} pt</span>
              ...
              {matches.length > 0 && (
                <div className="p-4 border-t border-slate-100 flex justify-between items-center">
                  <span className="text-xs text-slate-400">
                    {selected.size > 0 ? `${selected.size} KOCs selected` : "Select KOCs to send interest to"}
                  </span>
                  <button
                  ...
                  >
                    {sendingInterest ? "Sending..." : `🚀 Send Interest (${selected.size})`}
                  </button>
                </div>
              )}
            </div>
