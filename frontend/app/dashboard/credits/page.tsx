  ...
  return (
    <div className="min-h-screen bg-purple-50">
      ...
      <div className="max-w-lg mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-2xl border border-purple-100 shadow-sm p-8 text-center mb-6">
          ...
          <div className="space-y-2">
            {history.map((tx) => (
              <div key={tx.id as string} className="bg-white rounded-xl border border-zinc-100 p-4 flex justify-between items-center shadow-sm">
                <div>
                  <span className={`text-sm font-bold ${typeColor[tx.type as string] || "text-zinc-600"}`}>
                    {typeLabel[tx.type as string] || (tx.type as string)}
                  </span>
